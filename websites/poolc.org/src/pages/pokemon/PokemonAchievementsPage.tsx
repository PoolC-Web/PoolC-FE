...
const useStyles = createStyles(({ css }) => ({
  ...
  quest: css`display:grid; grid-template-columns:42px minmax(0, 1fr) auto; align-items:center; gap:14px; min-height:76px; padding:12px 16px; border:1px solid #e5eeeb; border-radius:6px; background:#fff; transition:border-color .2s, background .2s; ${media.mobile}{align-items:start; gap:10px; padding:12px;}`,
  ...
  questProgress: css`display:flex; align-items:center; gap:10px; margin-top:8px; .ant-progress{max-width:210px; flex:1;} strong{color:#747b77; font-size:.72rem; white-space:nowrap;} ${media.mobile}{gap:6px; .ant-progress{min-width:0;}}`,
}));
